# sanity-gatsby-aliyunoss-portfolio
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/ug0v6cfi/settings/api) and create a token with read rights.
